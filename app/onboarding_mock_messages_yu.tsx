...
const MockMessagesYu = () => {
  const handleFriendProfilePress = () => {
    ...
    // Handle friend profile press logic here
  };
  ...
  const friends = [
    { image: require('../assets/images/profile_picture.jpg'), name: 'Jpp123' },
        ...
        >
          <View style={styles.container}>
            <MessagingWithYuOnboarding
              ...
              friend={{ image: require('../assets/images/profile_picture.jpg'), name: 'Jpp123' }}
